...
4. **Color Discipline**:
   ...
   - Never hardcode `Colors.white`, `Colors.black`, `Colors.grey`, or fixed light backgrounds in production widgets unless intentionally theme-independent and justified.
...
8. **Verification**:
   - Never consider editing `app_colors.dart` alone a completed theme change; verify visible widgets consume theme roles.
